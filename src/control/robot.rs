...
impl Robot {
    ...
    pub fn add_i2c_device<Device: 'static, T: 'static, R: 'static>(&mut self, device: Box<Device>, handlers: Vec<Box<dyn I2CDeviceHandler<Device, T, R>>>) where Device: I2CDevice<T, R>, R: Into<u8>, T: From<(u8, Vec<u8>)> {
